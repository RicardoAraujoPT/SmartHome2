...
/**
 * This class represents a controller for User Story 08 (US08).
 * It provides a method that gives all the devices divided by type
 **/
...
public class US09GetDevicesByTypeController {
    ...
    public US09GetDevicesByTypeController(House house, Catalogue catalogue) throws IllegalArgumentException {
        if (!isValidConstructorArguments(house, catalogue)) throw (new IllegalArgumentException("Invalid arguments"));
        this._house = house;
    ...
    public HashMap<String, List<DeviceDTO>> getDevicesByType() {
        HashMap<String, HashMap<Room, List<Device>>> groupDevicesByType = this._house.groupDevicesByType();
