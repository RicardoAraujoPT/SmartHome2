...
/**
 * This class contains tests for the CAP200 sensor
 * It tests the creation of a new instance of CAP200 with valid parameters and checks if an exception is thrown when
 *
 *
 */
